...
/** 這次更新的內容，一行一條。 */
const UPDATE_LINES = [
    '· 按 Tab（或 I）打開玩家資訊：物品詳情、村民友誼、日曆',
    '· 有年曆了：一個月 28 天、一年 12 個月，每 3 個月一季，還有 8 個節日',
    '· 時鐘會顯示月份與當季圖標：嫩芽、太陽、楓葉、雪人',
    '· 當季盛產的材料採得更多；冬天天黑得早、夏天拖得晚',
    '· 店裡營業時間 08:00–20:00，一天結束會跳出當日結算',
    '· 撐到半夜昏倒一樣會演睡覺過場，醒來就在自己房間',
    '· 新增店鋪名聲與村民友誼，名聲越高顧客來得越快越多',
];
